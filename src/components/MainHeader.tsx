...
const MainHeader = ({ onMenuClick }: MainHeaderProps) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16 border-b border-white/10">
      <div className="bg-gradient-to-r from-[#1a1528] to-[#2d1f45] backdrop-blur-md h-full">
